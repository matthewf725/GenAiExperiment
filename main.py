...
def create_nn2_model(input_shape, output_shape):
    ...
    model.add(Dense(output_shape, activation='softmax'))  # Adjust activation based on the problem
...
input_text = ['This is a sample text.', 'Another example of text.']
...
nn3_model = train_nn3(scaled_data, processedinput, input_shape_nn3, output_shape_nn3)
...
correctness = evaluate_correctness(nn3_model, extract_patterns(nn1_model, scaled_data), extract_patterns(nn1_model, processedinput))
print(correctness)
